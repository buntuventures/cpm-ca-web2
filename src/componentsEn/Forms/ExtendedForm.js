      ...
      >
        ...
        >
          {this.state.serverError ? (
            <RequiredError text="We couldn't process your booking. Please try again, if the problem persist, Contact us at 613-252-5227 to book your appointment." />
          ) : null}
        </div>
      </div>
    );
...
const ReviewStep = (props) => {
  ...
  return (
    <div>
      <p style={{ padding: "20px 20px 10px", fontSize: "0.9rem" }}>
        Kindly confirm your information and select your desired call time for
        the appointment and your ideal consultation date.
      </p>
      ...
      >
        Applications are processed by CPM Admissions department Monday to Friday
        starting at 1:30PM. You will be contacted directly using the contact
        details you have given us within 1 working day to receive an
        appointment.
      </p>
      ...
      <div style={{ padding: "10px 20px 16px" }}>
        ...
        <div style={{ display: "flex", alignItems: "baseline" }}>
          <ToolTip fontSize="0.8rem">
            ...
            />
            <span style={{ paddingLeft: 6 }}>
              I accept the 48 hours cancellation policy
            </span>
          </ToolTip>
        </div>
        <div style={{ paddingLeft: 20, paddingBottom: 10 }}>
...
const ThankYou = () => (
  <div style={{ padding: 20 }}>
    <div style={{ padding: 20 }}>
      ...
      >
        <Image src={CheckCircle} alt="Icon Success" width={40} height={40} />
      </div>
    </div>
    <p>
      Your information has been submitted successfully. In a few moments you
      will receive our automatic confirmation email. Please, look in your junk
      mail folder in case it gets lost. (You can add admin [at] cpm-ca [dot] org
      to prevent antispam filtering.)
    </p>
    <p>
      The next step is to wait for our call. We will contact you as soon as
      possible to schedule an appointment.
    </p>
    <p>
      By setting an appointment with us, you are agreeing to{" "}
      <strong>
        <ToolTip fontSize="0.8rem">our 48-hour cancellation policy</ToolTip>
      </strong>
      , it is for the first appointment only, thereafter the conditions of the
      practitioner apply.
    </p>
    <p>
