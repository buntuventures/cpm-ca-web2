...
const CrisisLine = () => (
  <div>
    <Head>
      ...
      <meta
        name="description"
        content="If you are in crisis or danger, please use the following resources to get immediate help."
      />
    </Head>
    <div>
      <div style={{ maxWidth: 700, margin: "auto", padding: "40px 15px" }}>
        <div style={{ textAlign: "center" }}>
          ...
          <h3 style={{ fontWeight: 300 }}>
            If you are in crisis or danger, please use the following resources
