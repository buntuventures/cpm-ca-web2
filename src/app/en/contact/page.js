...
const Contact = ({ gDeviceWidth: deviceWidth }) => (
  <div>
    <div style={{ maxWidth: 1170, padding: "20px", margin: "auto" }}>
      <div className={classes.Address}>
        ...
        >
          <div>
            <h1>Contact Us</h1>
            <p>
              <strong>CPM: Center for Psychotromatology and Mediation</strong>
              <br />
              <span style={{ color: "#1689DF" }}>
                Monday - Friday: 9AM - 12PM & 1PM - 5PM
              </span>
              <br />
              427 McArthur Ave, 2e Floor, Suite #3
              <br />
      ...
      <div className={classes.Cancellation}>
        <div className={classes.CancellationItem}>
          ...
          <p>
            If you cancel or reschedule your first appointment with less than 48
            hours notice, or if you do not show up, you will be charged the full
        ...
        <div className={classes.CancellationItem}>
          <h2>Reimbursement</h2>
          <p>
            All our consultations can be partially or totally reimbursed by
            certain insurances. For further information please contact the
            secretariat.
          </p>
        </div>
      </div>
...
export const metadata = {
  title: "Contact us or book an appointment online.",
  description:
    "We take consultations from 9AM to 12PM and from 1PM to 5PM. Don't hesitate to contact us to book an appointment or for more information",
};
